  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background lg:hidden">
        <div className="app-container flex h-16 items-center justify-between pt-[env(safe-area-inset-top)]">
          <Logo />
      ...
      <header className="sticky top-0 z-50 hidden w-full border-b border-border/60 bg-background lg:block">
        <nav className="app-container relative flex h-[72px] items-center justify-between">
          <Logo />
